...
/*
   ...
   por unidad. Y segun una cantidad o un precio se le aplica un descuento
   u otro
...
int main() // Programa Principal
{
    ...
    /*
        Vemos si se puede aplicar el descuento por unidades.
        Y si ademas de superar las uniadades se superan el precio
        tambien se le aplica ese descuento
        Y como son acumulables se le suma al descuento total.
    */
    if( unidades > 100 )
    {
